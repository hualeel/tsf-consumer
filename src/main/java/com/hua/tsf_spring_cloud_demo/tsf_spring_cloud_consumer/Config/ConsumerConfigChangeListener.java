...
@Component
@ConfigChangeListener(prefix = "consumer.config", value = {"name"})
public class ConsumerConfigChangeListener implements ConfigChangeCallback {
    private static final Logger log = LoggerFactory.getLogger(ConsumerConfigChangeListener.class);
